...
FINAL_IMAGE=${DISTDIR}/I2C_class.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/I2C_class.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
