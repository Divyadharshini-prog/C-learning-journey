...
unsigned int battery_voltage = 175;
...
{
    unsigned char tens = voltage / 10;
    unsigned char tenths = voltage % 10;
    unsigned char hundreds = tens / 10;

    tens = tens % 10;

    Lcd_data(0x30 + hundreds);
    Lcd_data(0x30 + tens);
    Lcd_data('.');
    Lcd_data(0x30 + tenths);
