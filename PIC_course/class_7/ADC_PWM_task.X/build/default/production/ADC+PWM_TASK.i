...
unsigned char msg_ch0[10] = {"Ch0: "};
unsigned char msg_ch2[10] = {"Ch1: "};
...
void main() {
    ...
    while (1) {
        ...
        read_adc_channel(0);
        result_ch0 = (adc_high << 8) | adc_low;
        lcd_com(0x85);
        lcd_output_raw(result_ch0);


        read_adc_channel(2);
        result_ch2 = (adc_high << 8) | adc_low;

        result_ch2 = ((float)result_ch2 * 337 + 1023 / 2) / 1023;

        lcd_com(0xC5);
        lcd_output_cal(result_ch2);


        update_pwm_duty(result_ch0);
