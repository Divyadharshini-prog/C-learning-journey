...
# 2 "<built-in>" 2
# 1 "memory_mapping_task.c" 2
# 10 "memory_mapping_task.c"
...
# 19 "memory_mapping_task.c" 2
# 29 "memory_mapping_task.c"
...
void set_trisc(unsigned char value) {
     unsigned char* trisc_reg = (unsigned char*) 0x87;
    *trisc_reg = value;
}


void set_portc(unsigned char value) {
     unsigned char* portc_reg = (unsigned char*) 0x07;
    *portc_reg = value;
}
